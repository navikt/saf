...
import no.nav.saf.context.joark.domain.kode.FagomradeCode;
import no.nav.saf.context.joark.domain.kode.FagsystemCode;
import no.nav.saf.context.joark.domain.kode.FaktiskDistribusjonskanalCode;
...
import no.nav.saf.context.joark.domain.kode.UtsendingsKanalCode;
