...
import no.nav.saf.domain.visningsmodell.kode.DokumentStatus;
import no.nav.saf.domain.visningsmodell.kode.Dokumentkategori;
...
import no.nav.saf.legacycontext.joark.domain.DokumentInfoTo;
import no.nav.saf.legacycontext.joark.hentjournalsakinfo.HentJournalposterRequest;
import no.nav.saf.legacycontext.joark.hentjournalsakinfo.HentJournalposterResponse;
import no.nav.saf.legacycontext.joark.hentjournalsakinfo.HentJournalsakinfo;
