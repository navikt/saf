package no.nav.saf.legacycontext.gsak.hentgsaksaker;

import lombok.extern.slf4j.Slf4j;
import no.nav.saf.cache.CacheConfig;
import no.nav.saf.exceptions.SafFunctionalException;
import no.nav.saf.exceptions.SafTechnicalException;
import no.nav.saf.integration.fasit.ServiceuserAlias;
import no.nav.saf.legacycontext.gsak.domain.GsakSakerTo;
...
public class GsakConsumer {
	...
	@Cacheable(cacheNames = CacheConfig.SAKER_BY_AKTOER_ID_CACHE)
