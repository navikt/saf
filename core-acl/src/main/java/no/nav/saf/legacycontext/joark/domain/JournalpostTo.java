package no.nav.saf.legacycontext.joark.domain;

import lombok.AllArgsConstructor;
import lombok.Builder;
import lombok.Data;
import lombok.NoArgsConstructor;
import no.nav.saf.legacycontext.joark.domain.kode.FagomradeCode;
import no.nav.saf.legacycontext.joark.domain.kode.FagsystemCode;
import no.nav.saf.legacycontext.joark.domain.kode.FaktiskDistribusjonskanalCode;
...
import no.nav.saf.legacycontext.joark.domain.kode.MottaksKanalCode;
