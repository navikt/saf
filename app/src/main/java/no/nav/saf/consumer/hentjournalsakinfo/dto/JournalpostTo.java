...
import no.nav.saf.consumer.hentjournalsakinfo.dto.kode.FagomradeCode;
import no.nav.saf.consumer.hentjournalsakinfo.dto.kode.FagsystemCode;
import no.nav.saf.consumer.hentjournalsakinfo.dto.kode.FaktiskDistribusjonskanalCode;
import no.nav.saf.consumer.hentjournalsakinfo.dto.kode.JournalStatusCode;
import no.nav.saf.consumer.hentjournalsakinfo.dto.kode.JournalpostTypeCode;
import no.nav.saf.consumer.hentjournalsakinfo.dto.kode.MottaksKanalCode;
import no.nav.saf.consumer.hentjournalsakinfo.dto.kode.UtsendingsKanalCode;
