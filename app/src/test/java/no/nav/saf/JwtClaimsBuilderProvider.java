...
import static no.nav.saf.endpoints.testconfig.SecurityConfig.GOOGLE_ISSUER_URL;
import static no.nav.saf.endpoints.testconfig.SecurityConfig.NAV_STS_ISSUER_URL;
import static no.nav.saf.endpoints.testconfig.SecurityConfig.OPEN_AM_ISSUER_URL;
