...
public final class KeyGeneratorLocalCaching extends AbstractKeyGeneratorCaching {
	...
	public static String getKeyForPep2dLocalCaching(String tema) {
		return createIdentifierPair(RESSURSTYPE, RESSURSTYPE_SAK_DOKUMENT) + createUniqueIdentifier(createIdentifierPair(TEMA, tema));
	}

	public static String getKeyForPep5LocalCaching(String journalpostId, String dokumentInfoId) {
	...
	public static String getKeyForPep6dLocalCaching(String journalpostId, String dokumentInfoId, String variantFormat, String skjerming) {
