...
abstract class AbstractAbacBackedPepTest {
	...
	private static final String OIDC_TOKEN_SERVICEUSER_TEST_ROLE_BID = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..mgnYWCXKGGIPFIC7OW2_ymXp_a8-0ObRYAJWK2vSPg0";
	static String AKTOER_ID = "1234";
	static String FNR = "11111111111";
	static String FNR2 = "22222222222";
	static Tema TEMA_BID = BID;
	static Tema TEMA_HJE = HJE;
	...
	SafRequestContext createSafRequestContextSystem(String variantformatCode) {
		Map<String, Boolean> privilegiedServiceusers = Map.of(
				"srvsaf", true,
				"srvdokopp", true
		);
	...
	SafRequestContext createSafRequestContextSystemWithRoleBID(String variantformatCode) {
		Map<String, Boolean> privilegiedServiceusers = Map.of(
				"srvsaf", true,
				"srvdokopp", true
		);
		Map<String, JwtToken> issuerValidated = Map.of("azurev2", new JwtToken(OIDC_TOKEN_SERVICEUSER_TEST_ROLE_BID));
		return new SafRequestContext(NAV_CALLID, null, new TokenValidationContext(issuerValidated), privilegiedServiceusers, variantformatCode);
	}
}
